...
function create_subscription_table() {
    ...
    $sql_table1 = "CREATE TABLE IF NOT EXISTS $table1_name (
...
function add_custom_subscription_fields() {
    ...
    <div class="options_group">
        ...
        <p class="form-field">
            ...
            <input type="checkbox" class="checkbox" <?php checked($subscription_checkbox, 'yes'); ?> id="_subscription_checkbox" name="_subscription_checkbox" value="yes"> 
            <?php esc_html_e('Check this box to enable subscription for this product.', 'woocommerce'); ?>
        </p>

        <div id="subscription_fields" style="<?php echo ($subscription_checkbox === 'yes') ? '' : 'display: none;'; ?>">
...
?>
            ...
            <p class="form-field">
                ...
                <input type="hidden" id="subscription_price" name="subscription_price" value="<?php echo esc_attr($display_price); ?>" placeholder="<?php esc_attr_e('Price', 'textdomain'); ?>" placeholder="<?php esc_attr_e('Price', 'textdomain'); ?>" required>
            </p>
            <p class="form-field">
                <label for="subscription_duration"><?php esc_html_e('Duration', 'textdomain'); ?>:</label>
                <input type="number" id="subscription_duration" name="subscription_duration" value="<?php echo esc_attr($subscription_duration); ?>" placeholder="<?php esc_attr_e('Duration', 'textdomain'); ?>" required>
            </p>
            <p class="form-field">
                <label for="subscription_cycle"><?php esc_html_e('Cycle', 'textdomain'); ?>:</label>
                <input type="number" id="subscription_cycle" name="subscription_cycle" value="<?php echo esc_attr($subscription_cycle); ?>" placeholder="<?php esc_attr_e('Cycle', 'textdomain'); ?>">
            </p>
            <p class="form-field">
            ...
            <p class="form-field">
                ...
                <input type="text" id="trial_subscription_price" name="trial_subscription_price" value="<?php echo esc_attr($trial_subscription_price); ?>" placeholder="<?php esc_attr_e('Price', 'textdomain'); ?>" required>
            </p>
            <p class="form-field">
                <label for="trial_subscription_duration"><?php esc_html_e('Trial Duration', 'textdomain'); ?>:</label>
                <input type="number" id="trial_subscription_duration" name="trial_subscription_duration" value="<?php echo esc_attr($trial_subscription_duration); ?>" placeholder="<?php esc_attr_e('Duration', 'textdomain'); ?>" required>
            </p>
            <p class="form-field">
                <label for="trial_subscription_cycle"><?php esc_html_e('Trial Cycle', 'textdomain'); ?>:</label>
                <input type="number" id="trial_subscription_cycle" name="trial_subscription_cycle" value="<?php echo esc_attr($trial_subscription_cycle); ?>" placeholder="<?php esc_attr_e('Cycle', 'textdomain'); ?>">
            </p>
            <p class="form-field">
                <label for="trial_subscription_frequency"><?php esc_html_e('Trial Frequency', 'textdomain'); ?>:</label>
...
function display_subscribe_or_add_to_cart_button() {
 ...
 function update_subscription_data($product_id, $subscription_data) {
        ...
        if ($existing_subscription) {
            ...
            $wpdb->insert($table_name, array_merge($data, array('product_id' => $product_id)));
        }
    }
...
function register_custom_order_statuses() {
    ...
    register_post_status('wc-deactive', array(
...
function enqueue_custom_script() {
    wp_enqueue_script('custom-script', plugin_dir_url(__FILE__) . 'assets/js/script.js', array(), '1.0', true);
}
...
function enqueue_capture_button_script() {
    wp_enqueue_script('capture-button-script', get_template_directory_uri() . '/js/script.js', array(), '1.0', true);
}
