...
function showForm() {
    ...
    if (form) {
        console.log('Form found, showing...');
...
function setupButtonHandler() {
    ...
    if (showOtherPaymentButton) {
        console.log('Show other payment methods button found, setting up click handler...');
...
function setupFastCheckoutButtonHandler() {
    ...
    if (fastCheckoutButton) {
        console.log('Fast checkout button found, setting up click handler...');
...
var interval = setInterval(function() {
    ...
    if (showOtherPaymentButtonExists && fastCheckoutButtonExists) {
        ...
        console.log('One or both buttons not yet available, checking again...');
    }
}, 1000);